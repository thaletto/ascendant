...
df = DashaFinder(horoscope)

print(df.pretty_table())

# Get current + next dasha
print(df.get_dasha_by_index(-1))   # current
print(df.get_dasha_by_index(0))   # current
print(df.get_dasha_by_index(1))   # next